...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      ...
      GC_36 = (MDL_CW__EXP__2*MDL_EE__EXP__2*MDL_COMPLEXI)/MDL_SW__EXP_
     $ _2
      ...
      GC_72 = (MDL_EE__EXP__2*MDL_COMPLEXI*MDL_VEV)/(2.000000D
     $ +00*MDL_SW__EXP__2)
      GC_81 = MDL_EE__EXP__2*MDL_COMPLEXI*MDL_VEV+(MDL_CW__EXP__2
     $ *MDL_EE__EXP__2*MDL_COMPLEXI*MDL_VEV)/(2.000000D+00*MDL_SW__EXP_
     $ _2)+(MDL_EE__EXP__2*MDL_COMPLEXI*MDL_SW__EXP__2*MDL_VEV)
