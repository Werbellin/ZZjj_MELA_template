...
C     
C     Process: d s~ > z z u c~ QED=4 QCD=0 @1
C     *   Decay: z > e+ e- WEIGHTED=2
C     *   Decay: z > mu+ mu- WEIGHTED=2
C     Process: s d~ > z z c u~ QED=4 QCD=0 @1
C     *   Decay: z > e+ e- WEIGHTED=2
C     *   Decay: z > mu+ mu- WEIGHTED=2
C     
      IMPLICIT NONE
...
C     Amplitude(s) for diagram number 1
      ...
      CALL FFV2_3(W(1,1),W(1,3),GC_100,MDL_MW,MDL_WW,W(1,10))
...
C     Amplitude(s) for diagram number 3
      ...
      CALL FFV2_3_1(W(1,2),W(1,6),GC_50,GC_58,ZERO,ZERO,W(1,11))
...
C     Amplitude(s) for diagram number 10
      ...
      CALL FFV2_3(W(1,4),W(1,2),GC_100,MDL_MW,MDL_WW,W(1,13))
      CALL VVV1_2(W(1,13),W(1,6),GC_53,MDL_MW,MDL_WW,W(1,2))
C     Amplitude(s) for diagram number 11
      CALL FFV2_0(W(1,12),W(1,3),W(1,2),GC_100,AMP(11))
...
C     Amplitude(s) for diagram number 19
      CALL VVV1_0(W(1,2),W(1,10),W(1,5),GC_53,AMP(19))
...
C     Amplitude(s) for diagram number 22
      CALL FFV2_0(W(1,1),W(1,9),W(1,2),GC_100,AMP(22))
