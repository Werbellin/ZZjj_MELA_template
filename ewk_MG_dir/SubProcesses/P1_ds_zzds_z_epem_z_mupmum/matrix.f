...
C     
C     Process: d s > z z d s QED=4 QCD=0 @1
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV2_3_2(W(1,7),W(1,6),GC_50,GC_58,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,12),W(1,3),W(1,11),GC_1,AMP(3))
      CALL FFV2_3_3(W(1,2),W(1,4),GC_50,GC_58,MDL_MZ,MDL_WZ,W(1,13))
C     Amplitude(s) for diagram number 4
      CALL FFV2_3_0(W(1,12),W(1,3),W(1,13),GC_50,GC_58,AMP(4))
      CALL FFV2_3_1(W(1,3),W(1,6),GC_50,GC_58,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,7),W(1,12),W(1,11),GC_1,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFV2_3_0(W(1,7),W(1,12),W(1,13),GC_50,GC_58,AMP(6))
...
C     Amplitude(s) for diagram number 8
      ...
      CALL FFV1P0_3(W(1,10),W(1,3),GC_1,ZERO,ZERO,W(1,14))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,9),W(1,4),W(1,14),GC_1,AMP(9))
      CALL FFV2_3_3(W(1,10),W(1,3),GC_50,GC_58,MDL_MZ,MDL_WZ,W(1,15))
C     Amplitude(s) for diagram number 10
      CALL FFV2_3_0(W(1,9),W(1,4),W(1,15),GC_50,GC_58,AMP(10))
      CALL FFV2_3_2(W(1,10),W(1,5),GC_50,GC_58,ZERO,ZERO,W(1,16))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,16),W(1,3),W(1,11),GC_1,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV2_3_0(W(1,16),W(1,3),W(1,13),GC_50,GC_58,AMP(12))
      CALL FFV2_3_1(W(1,3),W(1,5),GC_50,GC_58,ZERO,ZERO,W(1,16))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,10),W(1,16),W(1,11),GC_1,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL FFV2_3_0(W(1,10),W(1,16),W(1,13),GC_50,GC_58,AMP(14))
...
C     Amplitude(s) for diagram number 17
      ...
      CALL FFV2_3_3(W(1,1),W(1,3),GC_50,GC_58,MDL_MZ,MDL_WZ,W(1,17))
...
C     Amplitude(s) for diagram number 36
      CALL FFV2_3_0(W(1,8),W(1,16),W(1,6),GC_50,GC_58,AMP(36))
      CALL FFV2_3_2(W(1,1),W(1,13),GC_50,GC_58,ZERO,ZERO,W(1,11))
C     Amplitude(s) for diagram number 37
      CALL FFV2_3_0(W(1,11),W(1,16),W(1,6),GC_50,GC_58,AMP(37))
C     Amplitude(s) for diagram number 38
      CALL FFV2_3_0(W(1,8),W(1,12),W(1,5),GC_50,GC_58,AMP(38))
C     Amplitude(s) for diagram number 39
      CALL FFV2_3_0(W(1,11),W(1,12),W(1,5),GC_50,GC_58,AMP(39))
