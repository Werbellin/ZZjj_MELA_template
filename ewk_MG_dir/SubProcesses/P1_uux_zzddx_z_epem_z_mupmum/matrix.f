...
C     
C     Process: u u~ > z z d d~ QED=4 QCD=0 @1
C     *   Decay: z > e+ e- WEIGHTED=2
C     *   Decay: z > mu+ mu- WEIGHTED=2
C     Process: c c~ > z z s s~ QED=4 QCD=0 @1
C     *   Decay: z > e+ e- WEIGHTED=2
C     *   Decay: z > mu+ mu- WEIGHTED=2
C     
      IMPLICIT NONE
...
C     Amplitude(s) for diagram number 3
      ...
      CALL FFV2_3(W(1,4),W(1,2),GC_100,MDL_MW,MDL_WW,W(1,12))
...
C     Amplitude(s) for diagram number 7
      ...
      CALL FFV2_3_3(W(1,4),W(1,3),GC_50,GC_58,MDL_MZ,MDL_WZ,W(1,16))
...
C     Amplitude(s) for diagram number 27
      ...
      CALL FFV2_5_3(W(1,1),W(1,2),GC_51,GC_58,MDL_MZ,MDL_WZ,W(1,17))
...
C     Amplitude(s) for diagram number 41
      ...
      CALL FFV2_3(W(1,1),W(1,3),GC_100,MDL_MW,MDL_WW,W(1,7))
...
C     Amplitude(s) for diagram number 60
      ...
      CALL FFV2_3(W(1,1),W(1,19),GC_100,MDL_MW,MDL_WW,W(1,3))
...
C     Amplitude(s) for diagram number 73
      CALL FFV2_0(W(1,4),W(1,13),W(1,3),GC_100,AMP(73))
