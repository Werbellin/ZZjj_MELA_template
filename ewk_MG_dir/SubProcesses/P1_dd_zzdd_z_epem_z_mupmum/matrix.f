...
C     
C     Process: d d > z z d d QED=4 QCD=0 @1
C     *   Decay: z > e+ e- WEIGHTED=2
C     *   Decay: z > mu+ mu- WEIGHTED=2
C     Process: s s > z z s s QED=4 QCD=0 @1
C     *   Decay: z > e+ e- WEIGHTED=2
C     *   Decay: z > mu+ mu- WEIGHTED=2
C     
      IMPLICIT NONE
...
C     ----------
      ...
      CALL FFV2_4_3(W(1,4),W(1,3),GC_50,GC_59,MDL_MZ,MDL_WZ,W(1,6))
      CALL OXXXXX(P(0,7),ZERO,NHEL(7),+1*IC(7),W(1,3))
      CALL OXXXXX(P(0,8),ZERO,NHEL(8),+1*IC(8),W(1,4))
      CALL FFV2_3_2(W(1,1),W(1,5),GC_50,GC_58,ZERO,ZERO,W(1,7))
      CALL FFV2_3_2(W(1,2),W(1,6),GC_50,GC_58,ZERO,ZERO,W(1,8))
      CALL FFV1P0_3(W(1,7),W(1,3),GC_1,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,8),W(1,4),W(1,9),GC_1,AMP(1))
      CALL FFV2_3_3(W(1,7),W(1,3),GC_50,GC_58,MDL_MZ,MDL_WZ,W(1,10))
C     Amplitude(s) for diagram number 2
      CALL FFV2_3_0(W(1,8),W(1,4),W(1,10),GC_50,GC_58,AMP(2))
      CALL FFV1P0_3(W(1,7),W(1,4),GC_1,ZERO,ZERO,W(1,11))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,8),W(1,3),W(1,11),GC_1,AMP(3))
      CALL FFV2_3_3(W(1,7),W(1,4),GC_50,GC_58,MDL_MZ,MDL_WZ,W(1,12))
C     Amplitude(s) for diagram number 4
      CALL FFV2_3_0(W(1,8),W(1,3),W(1,12),GC_50,GC_58,AMP(4))
      CALL FFV1P0_3(W(1,2),W(1,3),GC_1,ZERO,ZERO,W(1,13))
      CALL FFV2_3_2(W(1,7),W(1,6),GC_50,GC_58,ZERO,ZERO,W(1,14))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,14),W(1,4),W(1,13),GC_1,AMP(5))
      CALL FFV2_3_3(W(1,2),W(1,3),GC_50,GC_58,MDL_MZ,MDL_WZ,W(1,15))
C     Amplitude(s) for diagram number 6
      CALL FFV2_3_0(W(1,14),W(1,4),W(1,15),GC_50,GC_58,AMP(6))
      CALL FFV2_3_1(W(1,4),W(1,6),GC_50,GC_58,ZERO,ZERO,W(1,16))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,7),W(1,16),W(1,13),GC_1,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV2_3_0(W(1,7),W(1,16),W(1,15),GC_50,GC_58,AMP(8))
      CALL FFV1P0_3(W(1,2),W(1,4),GC_1,ZERO,ZERO,W(1,17))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,14),W(1,3),W(1,17),GC_1,AMP(9))
      CALL FFV2_3_3(W(1,2),W(1,4),GC_50,GC_58,MDL_MZ,MDL_WZ,W(1,18))
C     Amplitude(s) for diagram number 10
      CALL FFV2_3_0(W(1,14),W(1,3),W(1,18),GC_50,GC_58,AMP(10))
      CALL FFV2_3_1(W(1,3),W(1,6),GC_50,GC_58,ZERO,ZERO,W(1,14))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,7),W(1,14),W(1,17),GC_1,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV2_3_0(W(1,7),W(1,14),W(1,18),GC_50,GC_58,AMP(12))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,2),W(1,14),W(1,11),GC_1,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL FFV2_3_0(W(1,2),W(1,14),W(1,12),GC_50,GC_58,AMP(14))
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,2),W(1,16),W(1,9),GC_1,AMP(15))
C     Amplitude(s) for diagram number 16
      CALL FFV2_3_0(W(1,2),W(1,16),W(1,10),GC_50,GC_58,AMP(16))
      CALL FFV2_3_2(W(1,1),W(1,6),GC_50,GC_58,ZERO,ZERO,W(1,10))
      CALL FFV2_3_2(W(1,2),W(1,5),GC_50,GC_58,ZERO,ZERO,W(1,9))
      CALL FFV1P0_3(W(1,10),W(1,3),GC_1,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 17
      CALL FFV1_0(W(1,9),W(1,4),W(1,12),GC_1,AMP(17))
      CALL FFV2_3_3(W(1,10),W(1,3),GC_50,GC_58,MDL_MZ,MDL_WZ,W(1,11))
C     Amplitude(s) for diagram number 18
      CALL FFV2_3_0(W(1,9),W(1,4),W(1,11),GC_50,GC_58,AMP(18))
      CALL FFV1P0_3(W(1,10),W(1,4),GC_1,ZERO,ZERO,W(1,7))
C     Amplitude(s) for diagram number 19
      CALL FFV1_0(W(1,9),W(1,3),W(1,7),GC_1,AMP(19))
      CALL FFV2_3_3(W(1,10),W(1,4),GC_50,GC_58,MDL_MZ,MDL_WZ,W(1,19))
C     Amplitude(s) for diagram number 20
      CALL FFV2_3_0(W(1,9),W(1,3),W(1,19),GC_50,GC_58,AMP(20))
      CALL FFV2_3_2(W(1,10),W(1,5),GC_50,GC_58,ZERO,ZERO,W(1,20))
C     Amplitude(s) for diagram number 21
      CALL FFV1_0(W(1,20),W(1,4),W(1,13),GC_1,AMP(21))
C     Amplitude(s) for diagram number 22
      CALL FFV2_3_0(W(1,20),W(1,4),W(1,15),GC_50,GC_58,AMP(22))
      CALL FFV2_3_1(W(1,4),W(1,5),GC_50,GC_58,ZERO,ZERO,W(1,21))
C     Amplitude(s) for diagram number 23
      CALL FFV1_0(W(1,10),W(1,21),W(1,13),GC_1,AMP(23))
C     Amplitude(s) for diagram number 24
      CALL FFV2_3_0(W(1,10),W(1,21),W(1,15),GC_50,GC_58,AMP(24))
C     Amplitude(s) for diagram number 25
      CALL FFV1_0(W(1,20),W(1,3),W(1,17),GC_1,AMP(25))
C     Amplitude(s) for diagram number 26
      CALL FFV2_3_0(W(1,20),W(1,3),W(1,18),GC_50,GC_58,AMP(26))
      CALL FFV2_3_1(W(1,3),W(1,5),GC_50,GC_58,ZERO,ZERO,W(1,20))
C     Amplitude(s) for diagram number 27
      CALL FFV1_0(W(1,10),W(1,20),W(1,17),GC_1,AMP(27))
C     Amplitude(s) for diagram number 28
      CALL FFV2_3_0(W(1,10),W(1,20),W(1,18),GC_50,GC_58,AMP(28))
C     Amplitude(s) for diagram number 29
      CALL FFV1_0(W(1,2),W(1,20),W(1,7),GC_1,AMP(29))
C     Amplitude(s) for diagram number 30
      CALL FFV2_3_0(W(1,2),W(1,20),W(1,19),GC_50,GC_58,AMP(30))
C     Amplitude(s) for diagram number 31
      CALL FFV1_0(W(1,2),W(1,21),W(1,12),GC_1,AMP(31))
C     Amplitude(s) for diagram number 32
      CALL FFV2_3_0(W(1,2),W(1,21),W(1,11),GC_50,GC_58,AMP(32))
      CALL FFV1P0_3(W(1,1),W(1,3),GC_1,ZERO,ZERO,W(1,11))
      CALL FFV1_1(W(1,4),W(1,11),GC_1,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 33
      CALL FFV2_3_0(W(1,9),W(1,12),W(1,6),GC_50,GC_58,AMP(33))
      CALL FFV2_3_3(W(1,1),W(1,3),GC_50,GC_58,MDL_MZ,MDL_WZ,W(1,19))
      CALL FFV2_3_1(W(1,4),W(1,19),GC_50,GC_58,ZERO,ZERO,W(1,7))
C     Amplitude(s) for diagram number 34
      CALL FFV2_3_0(W(1,9),W(1,7),W(1,6),GC_50,GC_58,AMP(34))
C     Amplitude(s) for diagram number 35
      CALL FFV1_0(W(1,9),W(1,16),W(1,11),GC_1,AMP(35))
C     Amplitude(s) for diagram number 36
      CALL FFV2_3_0(W(1,9),W(1,16),W(1,19),GC_50,GC_58,AMP(36))
C     Amplitude(s) for diagram number 37
      CALL FFV2_3_0(W(1,8),W(1,12),W(1,5),GC_50,GC_58,AMP(37))
C     Amplitude(s) for diagram number 38
      CALL FFV2_3_0(W(1,8),W(1,7),W(1,5),GC_50,GC_58,AMP(38))
C     Amplitude(s) for diagram number 39
      CALL FFV1_0(W(1,8),W(1,21),W(1,11),GC_1,AMP(39))
C     Amplitude(s) for diagram number 40
      CALL FFV2_3_0(W(1,8),W(1,21),W(1,19),GC_50,GC_58,AMP(40))
      CALL VVS1_3(W(1,19),W(1,5),GC_81,MDL_MH,MDL_WH,W(1,7))
C     Amplitude(s) for diagram number 41
      CALL VVS1_0(W(1,18),W(1,6),W(1,7),GC_81,AMP(41))
      CALL VVS1_3(W(1,19),W(1,6),GC_81,MDL_MH,MDL_WH,W(1,7))
C     Amplitude(s) for diagram number 42
      CALL VVS1_0(W(1,18),W(1,5),W(1,7),GC_81,AMP(42))
      CALL VVS1_3(W(1,5),W(1,6),GC_81,MDL_MH,MDL_WH,W(1,7))
C     Amplitude(s) for diagram number 43
      CALL VVS1_0(W(1,19),W(1,18),W(1,7),GC_81,AMP(43))
      CALL FFV1_2(W(1,2),W(1,11),GC_1,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 44
      CALL FFV2_3_0(W(1,12),W(1,21),W(1,6),GC_50,GC_58,AMP(44))
      CALL FFV2_3_2(W(1,2),W(1,19),GC_50,GC_58,ZERO,ZERO,W(1,11))
C     Amplitude(s) for diagram number 45
      CALL FFV2_3_0(W(1,11),W(1,21),W(1,6),GC_50,GC_58,AMP(45))
C     Amplitude(s) for diagram number 46
      CALL FFV2_3_0(W(1,12),W(1,16),W(1,5),GC_50,GC_58,AMP(46))
C     Amplitude(s) for diagram number 47
      CALL FFV2_3_0(W(1,11),W(1,16),W(1,5),GC_50,GC_58,AMP(47))
      CALL FFV1P0_3(W(1,1),W(1,4),GC_1,ZERO,ZERO,W(1,11))
      CALL FFV1_1(W(1,3),W(1,11),GC_1,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 48
      CALL FFV2_3_0(W(1,9),W(1,12),W(1,6),GC_50,GC_58,AMP(48))
      CALL FFV2_3_3(W(1,1),W(1,4),GC_50,GC_58,MDL_MZ,MDL_WZ,W(1,19))
      CALL FFV2_3_1(W(1,3),W(1,19),GC_50,GC_58,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 49
      CALL FFV2_3_0(W(1,9),W(1,10),W(1,6),GC_50,GC_58,AMP(49))
C     Amplitude(s) for diagram number 50
      CALL FFV1_0(W(1,9),W(1,14),W(1,11),GC_1,AMP(50))
C     Amplitude(s) for diagram number 51
      CALL FFV2_3_0(W(1,9),W(1,14),W(1,19),GC_50,GC_58,AMP(51))
C     Amplitude(s) for diagram number 52
      CALL FFV2_3_0(W(1,8),W(1,12),W(1,5),GC_50,GC_58,AMP(52))
C     Amplitude(s) for diagram number 53
      CALL FFV2_3_0(W(1,8),W(1,10),W(1,5),GC_50,GC_58,AMP(53))
C     Amplitude(s) for diagram number 54
      CALL FFV1_0(W(1,8),W(1,20),W(1,11),GC_1,AMP(54))
C     Amplitude(s) for diagram number 55
      CALL FFV2_3_0(W(1,8),W(1,20),W(1,19),GC_50,GC_58,AMP(55))
      CALL VVS1_3(W(1,19),W(1,5),GC_81,MDL_MH,MDL_WH,W(1,10))
C     Amplitude(s) for diagram number 56
      CALL VVS1_0(W(1,15),W(1,6),W(1,10),GC_81,AMP(56))
      CALL VVS1_3(W(1,19),W(1,6),GC_81,MDL_MH,MDL_WH,W(1,10))
C     Amplitude(s) for diagram number 57
      CALL VVS1_0(W(1,15),W(1,5),W(1,10),GC_81,AMP(57))
C     Amplitude(s) for diagram number 58
      CALL VVS1_0(W(1,19),W(1,15),W(1,7),GC_81,AMP(58))
      CALL FFV1_2(W(1,2),W(1,11),GC_1,ZERO,ZERO,W(1,7))
C     Amplitude(s) for diagram number 59
      CALL FFV2_3_0(W(1,7),W(1,20),W(1,6),GC_50,GC_58,AMP(59))
      CALL FFV2_3_2(W(1,2),W(1,19),GC_50,GC_58,ZERO,ZERO,W(1,11))
C     Amplitude(s) for diagram number 60
      CALL FFV2_3_0(W(1,11),W(1,20),W(1,6),GC_50,GC_58,AMP(60))
C     Amplitude(s) for diagram number 61
      CALL FFV2_3_0(W(1,7),W(1,14),W(1,5),GC_50,GC_58,AMP(61))
C     Amplitude(s) for diagram number 62
      CALL FFV2_3_0(W(1,11),W(1,14),W(1,5),GC_50,GC_58,AMP(62))
      CALL FFV1P0_3(W(1,1),W(1,14),GC_1,ZERO,ZERO,W(1,11))
C     Amplitude(s) for diagram number 63
      CALL FFV1_0(W(1,9),W(1,4),W(1,11),GC_1,AMP(63))
      CALL FFV2_3_3(W(1,1),W(1,14),GC_50,GC_58,MDL_MZ,MDL_WZ,W(1,7))
C     Amplitude(s) for diagram number 64
      CALL FFV2_3_0(W(1,9),W(1,4),W(1,7),GC_50,GC_58,AMP(64))
      CALL FFV1P0_3(W(1,1),W(1,16),GC_1,ZERO,ZERO,W(1,19))
C     Amplitude(s) for diagram number 65
      CALL FFV1_0(W(1,9),W(1,3),W(1,19),GC_1,AMP(65))
      CALL FFV2_3_3(W(1,1),W(1,16),GC_50,GC_58,MDL_MZ,MDL_WZ,W(1,10))
C     Amplitude(s) for diagram number 66
      CALL FFV2_3_0(W(1,9),W(1,3),W(1,10),GC_50,GC_58,AMP(66))
      CALL FFV1P0_3(W(1,1),W(1,20),GC_1,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 67
      CALL FFV1_0(W(1,8),W(1,4),W(1,9),GC_1,AMP(67))
      CALL FFV2_3_3(W(1,1),W(1,20),GC_50,GC_58,MDL_MZ,MDL_WZ,W(1,12))
C     Amplitude(s) for diagram number 68
      CALL FFV2_3_0(W(1,8),W(1,4),W(1,12),GC_50,GC_58,AMP(68))
      CALL FFV1P0_3(W(1,1),W(1,21),GC_1,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 69
      CALL FFV1_0(W(1,8),W(1,3),W(1,4),GC_1,AMP(69))
      CALL FFV2_3_3(W(1,1),W(1,21),GC_50,GC_58,MDL_MZ,MDL_WZ,W(1,22))
C     Amplitude(s) for diagram number 70
      CALL FFV2_3_0(W(1,8),W(1,3),W(1,22),GC_50,GC_58,AMP(70))
      CALL FFV1_2(W(1,1),W(1,13),GC_1,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 71
      CALL FFV2_3_0(W(1,8),W(1,21),W(1,6),GC_50,GC_58,AMP(71))
      CALL FFV2_3_2(W(1,1),W(1,15),GC_50,GC_58,ZERO,ZERO,W(1,13))
C     Amplitude(s) for diagram number 72
      CALL FFV2_3_0(W(1,13),W(1,21),W(1,6),GC_50,GC_58,AMP(72))
C     Amplitude(s) for diagram number 73
      CALL FFV2_3_0(W(1,8),W(1,16),W(1,5),GC_50,GC_58,AMP(73))
C     Amplitude(s) for diagram number 74
      CALL FFV2_3_0(W(1,13),W(1,16),W(1,5),GC_50,GC_58,AMP(74))
      CALL FFV1_2(W(1,1),W(1,17),GC_1,ZERO,ZERO,W(1,13))
C     Amplitude(s) for diagram number 75
      CALL FFV2_3_0(W(1,13),W(1,20),W(1,6),GC_50,GC_58,AMP(75))
      CALL FFV2_3_2(W(1,1),W(1,18),GC_50,GC_58,ZERO,ZERO,W(1,17))
C     Amplitude(s) for diagram number 76
      CALL FFV2_3_0(W(1,17),W(1,20),W(1,6),GC_50,GC_58,AMP(76))
C     Amplitude(s) for diagram number 77
      CALL FFV2_3_0(W(1,13),W(1,14),W(1,5),GC_50,GC_58,AMP(77))
C     Amplitude(s) for diagram number 78
      CALL FFV2_3_0(W(1,17),W(1,14),W(1,5),GC_50,GC_58,AMP(78))
C     Amplitude(s) for diagram number 79
      CALL FFV1_0(W(1,2),W(1,16),W(1,9),GC_1,AMP(79))
C     Amplitude(s) for diagram number 80
      CALL FFV2_3_0(W(1,2),W(1,16),W(1,12),GC_50,GC_58,AMP(80))
C     Amplitude(s) for diagram number 81
      CALL FFV1_0(W(1,2),W(1,20),W(1,19),GC_1,AMP(81))
C     Amplitude(s) for diagram number 82
      CALL FFV2_3_0(W(1,2),W(1,20),W(1,10),GC_50,GC_58,AMP(82))
C     Amplitude(s) for diagram number 83
      CALL FFV1_0(W(1,2),W(1,14),W(1,4),GC_1,AMP(83))
C     Amplitude(s) for diagram number 84
      CALL FFV2_3_0(W(1,2),W(1,14),W(1,22),GC_50,GC_58,AMP(84))
C     Amplitude(s) for diagram number 85
      CALL FFV1_0(W(1,2),W(1,21),W(1,11),GC_1,AMP(85))
C     Amplitude(s) for diagram number 86
      CALL FFV2_3_0(W(1,2),W(1,21),W(1,7),GC_50,GC_58,AMP(86))
      JAMP(1)=-AMP(1)-AMP(2)-AMP(9)-AMP(10)-AMP(11)-AMP(12)-AMP(15)
     $ -AMP(16)-AMP(17)-AMP(18)-AMP(25)-AMP(26)-AMP(27)-AMP(28)
     $ -AMP(31)-AMP(32)-AMP(33)-AMP(34)-AMP(35)-AMP(36)-AMP(37)
     $ -AMP(38)-AMP(39)-AMP(40)-AMP(41)-AMP(42)-AMP(43)-AMP(44)
     $ -AMP(45)-AMP(46)-AMP(47)-AMP(63)-AMP(64)-AMP(67)-AMP(68)
     $ -AMP(75)-AMP(76)-AMP(77)-AMP(78)-AMP(79)-AMP(80)-AMP(85)-AMP(86)
      JAMP(2)=+AMP(3)+AMP(4)+AMP(5)+AMP(6)+AMP(7)+AMP(8)+AMP(13)
     $ +AMP(14)+AMP(19)+AMP(20)+AMP(21)+AMP(22)+AMP(23)+AMP(24)
     $ +AMP(29)+AMP(30)+AMP(48)+AMP(49)+AMP(50)+AMP(51)+AMP(52)
     $ +AMP(53)+AMP(54)+AMP(55)+AMP(56)+AMP(57)+AMP(58)+AMP(59)
     $ +AMP(60)+AMP(61)+AMP(62)+AMP(65)+AMP(66)+AMP(69)+AMP(70)
     $ +AMP(71)+AMP(72)+AMP(73)+AMP(74)+AMP(81)+AMP(82)+AMP(83)+AMP(84)
