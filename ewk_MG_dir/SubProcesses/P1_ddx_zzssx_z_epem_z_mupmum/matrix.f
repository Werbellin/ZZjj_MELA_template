...
C     
C     Process: d d~ > z z s s~ QED=4 QCD=0 @1
C     *   Decay: z > e+ e- WEIGHTED=2
C     *   Decay: z > mu+ mu- WEIGHTED=2
C     Process: s s~ > z z d d~ QED=4 QCD=0 @1
C     *   Decay: z > e+ e- WEIGHTED=2
C     *   Decay: z > mu+ mu- WEIGHTED=2
C     
      IMPLICIT NONE
...
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,12),W(1,2),W(1,11),GC_1,AMP(3))
      CALL FFV2_3_3(W(1,4),W(1,3),GC_50,GC_58,MDL_MZ,MDL_WZ,W(1,13))
C     Amplitude(s) for diagram number 4
      CALL FFV2_3_0(W(1,12),W(1,2),W(1,13),GC_50,GC_58,AMP(4))
      CALL FFV2_3_1(W(1,2),W(1,6),GC_50,GC_58,ZERO,ZERO,W(1,12))
...
C     Amplitude(s) for diagram number 8
      ...
      CALL FFV1P0_3(W(1,10),W(1,2),GC_1,ZERO,ZERO,W(1,14))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,9),W(1,3),W(1,14),GC_1,AMP(9))
      CALL FFV2_3_3(W(1,10),W(1,2),GC_50,GC_58,MDL_MZ,MDL_WZ,W(1,15))
C     Amplitude(s) for diagram number 10
      CALL FFV2_3_0(W(1,9),W(1,3),W(1,15),GC_50,GC_58,AMP(10))
      CALL FFV2_3_2(W(1,10),W(1,5),GC_50,GC_58,ZERO,ZERO,W(1,16))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,16),W(1,2),W(1,11),GC_1,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV2_3_0(W(1,16),W(1,2),W(1,13),GC_50,GC_58,AMP(12))
      CALL FFV2_3_1(W(1,2),W(1,5),GC_50,GC_58,ZERO,ZERO,W(1,16))
...
C     Amplitude(s) for diagram number 17
      ...
      CALL FFV2_3_3(W(1,1),W(1,2),GC_50,GC_58,MDL_MZ,MDL_WZ,W(1,17))
...
C     Amplitude(s) for diagram number 27
      ...
      CALL FFV1_2(W(1,4),W(1,15),GC_1,ZERO,ZERO,W(1,2))
...
C     Amplitude(s) for diagram number 32
      ...
      CALL FFV2_3_3(W(1,1),W(1,12),GC_50,GC_58,MDL_MZ,MDL_WZ,W(1,2))
...
C     Amplitude(s) for diagram number 43
      CALL FFV2_3_0(W(1,4),W(1,10),W(1,2),GC_50,GC_58,AMP(43))
