...
C     
C     Process: u c~ > z z d s~ QED=4 QCD=0 @1
C     *   Decay: z > e+ e- WEIGHTED=2
C     *   Decay: z > mu+ mu- WEIGHTED=2
C     Process: c u~ > z z s d~ QED=4 QCD=0 @1
C     *   Decay: z > e+ e- WEIGHTED=2
C     *   Decay: z > mu+ mu- WEIGHTED=2
C     
      IMPLICIT NONE
...
C     Amplitude(s) for diagram number 1
      ...
      CALL FFV2_3(W(1,4),W(1,2),GC_100,MDL_MW,MDL_WW,W(1,10))
...
C     Amplitude(s) for diagram number 5
      ...
      CALL FFV2_3_2(W(1,4),W(1,5),GC_50,GC_58,ZERO,ZERO,W(1,12))
...
C     Amplitude(s) for diagram number 10
      CALL FFV2_0(W(1,4),W(1,9),W(1,13),GC_100,AMP(10))
      CALL FFV2_3(W(1,1),W(1,3),GC_100,MDL_MW,MDL_WW,W(1,13))
...
C     Amplitude(s) for diagram number 20
      ...
      CALL FFV2_2(W(1,4),W(1,13),GC_100,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 21
      CALL FFV2_5_0(W(1,15),W(1,9),W(1,6),GC_51,GC_58,AMP(21))
C     Amplitude(s) for diagram number 22
      CALL FFV2_0(W(1,4),W(1,9),W(1,3),GC_100,AMP(22))
C     Amplitude(s) for diagram number 23
      CALL FFV2_5_0(W(1,15),W(1,7),W(1,5),GC_51,GC_58,AMP(23))
C     Amplitude(s) for diagram number 24
      CALL FFV2_0(W(1,4),W(1,7),W(1,16),GC_100,AMP(24))
...
C     Amplitude(s) for diagram number 31
      CALL FFV2_0(W(1,4),W(1,9),W(1,16),GC_100,AMP(31))
C     Amplitude(s) for diagram number 32
      CALL FFV2_0(W(1,4),W(1,7),W(1,12),GC_100,AMP(32))
