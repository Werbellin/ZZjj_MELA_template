...
C     
C     Process: d c~ > z z d c~ QED=4 QCD=0 @1
C     *   Decay: z > e+ e- WEIGHTED=2
C     *   Decay: z > mu+ mu- WEIGHTED=2
C     Process: s u~ > z z s u~ QED=4 QCD=0 @1
C     *   Decay: z > e+ e- WEIGHTED=2
C     *   Decay: z > mu+ mu- WEIGHTED=2
C     
      IMPLICIT NONE
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV2_5_2(W(1,7),W(1,6),GC_51,GC_58,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,12),W(1,2),W(1,11),GC_2,AMP(3))
      CALL FFV2_3_3(W(1,1),W(1,3),GC_50,GC_58,MDL_MZ,MDL_WZ,W(1,13))
C     Amplitude(s) for diagram number 4
      CALL FFV2_5_0(W(1,12),W(1,2),W(1,13),GC_51,GC_58,AMP(4))
      CALL FFV2_5_1(W(1,2),W(1,6),GC_51,GC_58,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,7),W(1,12),W(1,11),GC_2,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFV2_5_0(W(1,7),W(1,12),W(1,13),GC_51,GC_58,AMP(6))
      CALL FFV2_3_1(W(1,3),W(1,6),GC_50,GC_58,ZERO,ZERO,W(1,7))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,1),W(1,7),W(1,9),GC_1,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV2_3_0(W(1,1),W(1,7),W(1,10),GC_50,GC_58,AMP(8))
      CALL FFV2_5_2(W(1,4),W(1,6),GC_51,GC_58,ZERO,ZERO,W(1,10))
      CALL FFV2_3_2(W(1,1),W(1,5),GC_50,GC_58,ZERO,ZERO,W(1,9))
      CALL FFV1P0_3(W(1,10),W(1,2),GC_2,ZERO,ZERO,W(1,14))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,9),W(1,3),W(1,14),GC_1,AMP(9))
      CALL FFV2_5_3(W(1,10),W(1,2),GC_51,GC_58,MDL_MZ,MDL_WZ,W(1,15))
C     Amplitude(s) for diagram number 10
      CALL FFV2_3_0(W(1,9),W(1,3),W(1,15),GC_50,GC_58,AMP(10))
      CALL FFV2_5_2(W(1,10),W(1,5),GC_51,GC_58,ZERO,ZERO,W(1,16))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,16),W(1,2),W(1,11),GC_2,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV2_5_0(W(1,16),W(1,2),W(1,13),GC_51,GC_58,AMP(12))
      CALL FFV2_5_1(W(1,2),W(1,5),GC_51,GC_58,ZERO,ZERO,W(1,16))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,10),W(1,16),W(1,11),GC_2,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL FFV2_5_0(W(1,10),W(1,16),W(1,13),GC_51,GC_58,AMP(14))
      CALL FFV2_3_1(W(1,3),W(1,5),GC_50,GC_58,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,1),W(1,10),W(1,14),GC_1,AMP(15))
C     Amplitude(s) for diagram number 16
      CALL FFV2_3_0(W(1,1),W(1,10),W(1,15),GC_50,GC_58,AMP(16))
      CALL FFV1P0_3(W(1,4),W(1,2),GC_2,ZERO,ZERO,W(1,15))
      CALL FFV1_1(W(1,3),W(1,15),GC_1,ZERO,ZERO,W(1,14))
C     Amplitude(s) for diagram number 17
      CALL FFV2_3_0(W(1,9),W(1,14),W(1,6),GC_50,GC_58,AMP(17))
      CALL FFV2_5_3(W(1,4),W(1,2),GC_51,GC_58,MDL_MZ,MDL_WZ,W(1,17))
      CALL FFV2_3_1(W(1,3),W(1,17),GC_50,GC_58,ZERO,ZERO,W(1,2))
C     Amplitude(s) for diagram number 18
      CALL FFV2_3_0(W(1,9),W(1,2),W(1,6),GC_50,GC_58,AMP(18))
C     Amplitude(s) for diagram number 19
      CALL FFV1_0(W(1,9),W(1,7),W(1,15),GC_1,AMP(19))
C     Amplitude(s) for diagram number 20
      CALL FFV2_3_0(W(1,9),W(1,7),W(1,17),GC_50,GC_58,AMP(20))
C     Amplitude(s) for diagram number 21
      CALL FFV2_3_0(W(1,8),W(1,14),W(1,5),GC_50,GC_58,AMP(21))
C     Amplitude(s) for diagram number 22
      CALL FFV2_3_0(W(1,8),W(1,2),W(1,5),GC_50,GC_58,AMP(22))
C     Amplitude(s) for diagram number 23
      CALL FFV1_0(W(1,8),W(1,10),W(1,15),GC_1,AMP(23))
C     Amplitude(s) for diagram number 24
      CALL FFV2_3_0(W(1,8),W(1,10),W(1,17),GC_50,GC_58,AMP(24))
      CALL VVS1_3(W(1,17),W(1,5),GC_81,MDL_MH,MDL_WH,W(1,2))
C     Amplitude(s) for diagram number 25
      CALL VVS1_0(W(1,13),W(1,6),W(1,2),GC_81,AMP(25))
      CALL VVS1_3(W(1,17),W(1,6),GC_81,MDL_MH,MDL_WH,W(1,2))
C     Amplitude(s) for diagram number 26
      CALL VVS1_0(W(1,13),W(1,5),W(1,2),GC_81,AMP(26))
      CALL VVS1_3(W(1,5),W(1,6),GC_81,MDL_MH,MDL_WH,W(1,2))
C     Amplitude(s) for diagram number 27
      CALL VVS1_0(W(1,17),W(1,13),W(1,2),GC_81,AMP(27))
      CALL FFV1_2(W(1,1),W(1,15),GC_1,ZERO,ZERO,W(1,2))
C     Amplitude(s) for diagram number 28
      CALL FFV2_3_0(W(1,2),W(1,10),W(1,6),GC_50,GC_58,AMP(28))
      CALL FFV2_3_2(W(1,1),W(1,17),GC_50,GC_58,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 29
      CALL FFV2_3_0(W(1,15),W(1,10),W(1,6),GC_50,GC_58,AMP(29))
C     Amplitude(s) for diagram number 30
      CALL FFV2_3_0(W(1,2),W(1,7),W(1,5),GC_50,GC_58,AMP(30))
C     Amplitude(s) for diagram number 31
      CALL FFV2_3_0(W(1,15),W(1,7),W(1,5),GC_50,GC_58,AMP(31))
      CALL FFV1P0_3(W(1,4),W(1,12),GC_2,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 32
      CALL FFV1_0(W(1,9),W(1,3),W(1,15),GC_1,AMP(32))
      CALL FFV2_5_3(W(1,4),W(1,12),GC_51,GC_58,MDL_MZ,MDL_WZ,W(1,2))
C     Amplitude(s) for diagram number 33
      CALL FFV2_3_0(W(1,9),W(1,3),W(1,2),GC_50,GC_58,AMP(33))
      CALL FFV1P0_3(W(1,4),W(1,16),GC_2,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 34
      CALL FFV1_0(W(1,8),W(1,3),W(1,9),GC_1,AMP(34))
      CALL FFV2_5_3(W(1,4),W(1,16),GC_51,GC_58,MDL_MZ,MDL_WZ,W(1,17))
C     Amplitude(s) for diagram number 35
      CALL FFV2_3_0(W(1,8),W(1,3),W(1,17),GC_50,GC_58,AMP(35))
      CALL FFV1_2(W(1,4),W(1,11),GC_2,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 36
      CALL FFV2_5_0(W(1,8),W(1,16),W(1,6),GC_51,GC_58,AMP(36))
      CALL FFV2_5_2(W(1,4),W(1,13),GC_51,GC_58,ZERO,ZERO,W(1,11))
C     Amplitude(s) for diagram number 37
      CALL FFV2_5_0(W(1,11),W(1,16),W(1,6),GC_51,GC_58,AMP(37))
C     Amplitude(s) for diagram number 38
      CALL FFV2_5_0(W(1,8),W(1,12),W(1,5),GC_51,GC_58,AMP(38))
C     Amplitude(s) for diagram number 39
      CALL FFV2_5_0(W(1,11),W(1,12),W(1,5),GC_51,GC_58,AMP(39))
C     Amplitude(s) for diagram number 40
      CALL FFV1_0(W(1,1),W(1,7),W(1,9),GC_1,AMP(40))
C     Amplitude(s) for diagram number 41
      CALL FFV2_3_0(W(1,1),W(1,7),W(1,17),GC_50,GC_58,AMP(41))
C     Amplitude(s) for diagram number 42
      CALL FFV1_0(W(1,1),W(1,10),W(1,15),GC_1,AMP(42))
C     Amplitude(s) for diagram number 43
      CALL FFV2_3_0(W(1,1),W(1,10),W(1,2),GC_50,GC_58,AMP(43))
