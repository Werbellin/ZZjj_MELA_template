...
C     Process: c u~ > z z c u~ QED=4 QCD=0 @1
C     *   Decay: z > e+ e- WEIGHTED=2
C     *   Decay: z > mu+ mu- WEIGHTED=2
C     
      IMPLICIT NONE
...
C     Amplitude(s) for diagram number 17
      ...
      CALL FFV2_5_1(W(1,2),W(1,17),GC_51,GC_58,ZERO,ZERO,W(1,3))
...
C     Amplitude(s) for diagram number 27
      ...
      CALL FFV1_2(W(1,4),W(1,15),GC_2,ZERO,ZERO,W(1,3))
...
C     Amplitude(s) for diagram number 33
      CALL FFV2_5_0(W(1,9),W(1,2),W(1,3),GC_51,GC_58,AMP(33))
...
C     Amplitude(s) for diagram number 43
      CALL FFV2_5_0(W(1,4),W(1,10),W(1,3),GC_51,GC_58,AMP(43))
