...
C     
C     Process: u d~ > z z c s~ QED=4 QCD=0 @1
C     *   Decay: z > e+ e- WEIGHTED=2
C     *   Decay: z > mu+ mu- WEIGHTED=2
C     Process: c s~ > z z u d~ QED=4 QCD=0 @1
C     *   Decay: z > e+ e- WEIGHTED=2
C     *   Decay: z > mu+ mu- WEIGHTED=2
C     
      IMPLICIT NONE
...
C     Amplitude(s) for diagram number 1
      ...
      CALL FFV2_3(W(1,4),W(1,3),GC_100,MDL_MW,MDL_WW,W(1,10))
...
C     Amplitude(s) for diagram number 10
      ...
      CALL FFV2_3(W(1,1),W(1,2),GC_100,MDL_MW,MDL_WW,W(1,13))
