...
C     
C     Process: d d~ > z z c c~ QED=4 QCD=0 @1
C     *   Decay: z > e+ e- WEIGHTED=2
C     *   Decay: z > mu+ mu- WEIGHTED=2
C     Process: s s~ > z z u u~ QED=4 QCD=0 @1
C     *   Decay: z > e+ e- WEIGHTED=2
C     *   Decay: z > mu+ mu- WEIGHTED=2
C     
      IMPLICIT NONE
...
C     Amplitude(s) for diagram number 3
      ...
      CALL FFV2_3_3(W(1,1),W(1,2),GC_50,GC_58,MDL_MZ,MDL_WZ,W(1,13))
...
C     Amplitude(s) for diagram number 16
      ...
      CALL FFV1P0_3(W(1,4),W(1,3),GC_2,ZERO,ZERO,W(1,15))
...
C     Amplitude(s) for diagram number 17
      ...
      CALL FFV2_3_1(W(1,2),W(1,17),GC_50,GC_58,ZERO,ZERO,W(1,3))
...
C     Amplitude(s) for diagram number 27
      ...
      CALL FFV1_2(W(1,1),W(1,15),GC_1,ZERO,ZERO,W(1,3))
...
C     Amplitude(s) for diagram number 32
      ...
      CALL FFV2_5_3(W(1,4),W(1,12),GC_51,GC_58,MDL_MZ,MDL_WZ,W(1,3))
C     Amplitude(s) for diagram number 33
      CALL FFV2_3_0(W(1,9),W(1,2),W(1,3),GC_50,GC_58,AMP(33))
...
C     Amplitude(s) for diagram number 43
      CALL FFV2_3_0(W(1,1),W(1,10),W(1,3),GC_50,GC_58,AMP(43))
