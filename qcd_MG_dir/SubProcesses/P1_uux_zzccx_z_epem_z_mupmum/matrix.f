...
C     
C     Process: u u~ > z z c c~ QED=2 QCD=2 @1
C     *   Decay: z > e+ e- WEIGHTED=2
C     *   Decay: z > mu+ mu- WEIGHTED=2
C     Process: c c~ > z z u u~ QED=2 QCD=2 @1
C     *   Decay: z > e+ e- WEIGHTED=2
C     *   Decay: z > mu+ mu- WEIGHTED=2
C     
      IMPLICIT NONE
...
C     Amplitude(s) for diagram number 9
      CALL FFV2_5_0(W(1,12),W(1,2),W(1,6),GC_51,GC_58,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,12),W(1,7),W(1,13),GC_11,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV2_5_0(W(1,8),W(1,2),W(1,5),GC_51,GC_58,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,8),W(1,9),W(1,13),GC_11,AMP(12))
      CALL FFV1_2(W(1,4),W(1,13),GC_11,ZERO,ZERO,W(1,2))
C     Amplitude(s) for diagram number 13
      CALL FFV2_5_0(W(1,2),W(1,9),W(1,6),GC_51,GC_58,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL FFV2_5_0(W(1,2),W(1,7),W(1,5),GC_51,GC_58,AMP(14))
      CALL FFV1P0_3(W(1,1),W(1,11),GC_11,ZERO,ZERO,W(1,2))
