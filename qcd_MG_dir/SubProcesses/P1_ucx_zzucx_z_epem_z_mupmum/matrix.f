...
C     
C     Process: u c~ > z z u c~ QED=2 QCD=2 @1
C     *   Decay: z > e+ e- WEIGHTED=2
C     *   Decay: z > mu+ mu- WEIGHTED=2
C     Process: c u~ > z z c u~ QED=2 QCD=2 @1
C     *   Decay: z > e+ e- WEIGHTED=2
C     *   Decay: z > mu+ mu- WEIGHTED=2
C     
      IMPLICIT NONE
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV2_5_1(W(1,3),W(1,6),GC_51,GC_58,ZERO,ZERO,W(1,11))
...
C     Amplitude(s) for diagram number 4
      ...
      CALL FFV2_5_2(W(1,4),W(1,5),GC_51,GC_58,ZERO,ZERO,W(1,12))
      CALL FFV1P0_3(W(1,9),W(1,3),GC_11,ZERO,ZERO,W(1,13))
...
C     Amplitude(s) for diagram number 6
      ...
      CALL FFV2_5_1(W(1,3),W(1,5),GC_51,GC_58,ZERO,ZERO,W(1,14))
...
C     Amplitude(s) for diagram number 8
      ...
      CALL FFV1_1(W(1,2),W(1,13),GC_11,ZERO,ZERO,W(1,3))
C     Amplitude(s) for diagram number 9
      CALL FFV2_5_0(W(1,12),W(1,3),W(1,6),GC_51,GC_58,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,12),W(1,7),W(1,13),GC_11,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV2_5_0(W(1,8),W(1,3),W(1,5),GC_51,GC_58,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,8),W(1,9),W(1,13),GC_11,AMP(12))
      CALL FFV1_2(W(1,4),W(1,13),GC_11,ZERO,ZERO,W(1,3))
C     Amplitude(s) for diagram number 13
      CALL FFV2_5_0(W(1,3),W(1,9),W(1,6),GC_51,GC_58,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL FFV2_5_0(W(1,3),W(1,7),W(1,5),GC_51,GC_58,AMP(14))
      CALL FFV1P0_3(W(1,1),W(1,11),GC_11,ZERO,ZERO,W(1,3))
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,12),W(1,2),W(1,3),GC_11,AMP(15))
      CALL FFV1P0_3(W(1,1),W(1,14),GC_11,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,8),W(1,2),W(1,12),GC_11,AMP(16))
      CALL FFV1_2(W(1,1),W(1,10),GC_11,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 17
      CALL FFV2_5_0(W(1,8),W(1,14),W(1,6),GC_51,GC_58,AMP(17))
C     Amplitude(s) for diagram number 18
      CALL FFV2_5_0(W(1,8),W(1,11),W(1,5),GC_51,GC_58,AMP(18))
C     Amplitude(s) for diagram number 19
      CALL FFV1_0(W(1,4),W(1,7),W(1,12),GC_11,AMP(19))
C     Amplitude(s) for diagram number 20
      CALL FFV1_0(W(1,4),W(1,9),W(1,3),GC_11,AMP(20))
      JAMP(1)=+1D0/2D0*(+AMP(1)+AMP(2)+AMP(3)+AMP(4)+AMP(5)+AMP(6)
     $ +AMP(7)+AMP(8)+AMP(9)+AMP(10)+AMP(11)+AMP(12)+AMP(13)+AMP(14)
     $ +AMP(15)+AMP(16)+AMP(17)+AMP(18)+AMP(19)+AMP(20))
      JAMP(2)=+1D0/2D0*(-1D0/3D0*AMP(1)-1D0/3D0*AMP(2)-1D0/3D0*AMP(3)
     $ -1D0/3D0*AMP(4)-1D0/3D0*AMP(5)-1D0/3D0*AMP(6)-1D0/3D0*AMP(7)
     $ -1D0/3D0*AMP(8)-1D0/3D0*AMP(9)-1D0/3D0*AMP(10)-1D0/3D0*AMP(11)
     $ -1D0/3D0*AMP(12)-1D0/3D0*AMP(13)-1D0/3D0*AMP(14)-1D0/3D0
     $ *AMP(15)-1D0/3D0*AMP(16)-1D0/3D0*AMP(17)-1D0/3D0*AMP(18)
     $ -1D0/3D0*AMP(19)-1D0/3D0*AMP(20))
