...
C     
C     Process: g g > z z d d~ QED=2 QCD=2 @1
C     *   Decay: z > e+ e- WEIGHTED=2
C     *   Decay: z > mu+ mu- WEIGHTED=2
C     Process: g g > z z s s~ QED=2 QCD=2 @1
C     *   Decay: z > e+ e- WEIGHTED=2
C     *   Decay: z > mu+ mu- WEIGHTED=2
C     
      IMPLICIT NONE
...
C     ----------
      ...
      CALL FFV2_3_1(W(1,3),W(1,5),GC_50,GC_58,ZERO,ZERO,W(1,8))
...
C     Amplitude(s) for diagram number 12
      ...
      CALL FFV2_3_2(W(1,7),W(1,5),GC_50,GC_58,ZERO,ZERO,W(1,3))
