...
C     
C     Process: d d > z z d d QED=2 QCD=2 @1
C     *   Decay: z > e+ e- WEIGHTED=2
C     *   Decay: z > mu+ mu- WEIGHTED=2
C     Process: s s > z z s s QED=2 QCD=2 @1
C     *   Decay: z > e+ e- WEIGHTED=2
C     *   Decay: z > mu+ mu- WEIGHTED=2
C     
      IMPLICIT NONE
...
C     Amplitude(s) for diagram number 3
      ...
      CALL FFV2_3_1(W(1,4),W(1,6),GC_50,GC_58,ZERO,ZERO,W(1,13))
...
C     Amplitude(s) for diagram number 8
      ...
      CALL FFV2_3_2(W(1,1),W(1,6),GC_50,GC_58,ZERO,ZERO,W(1,9))
      CALL FFV2_3_2(W(1,2),W(1,5),GC_50,GC_58,ZERO,ZERO,W(1,10))
...
C     Amplitude(s) for diagram number 10
      ...
      CALL FFV2_3_2(W(1,9),W(1,5),GC_50,GC_58,ZERO,ZERO,W(1,16))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,16),W(1,4),W(1,11),GC_11,AMP(11))
      CALL FFV2_3_1(W(1,4),W(1,5),GC_50,GC_58,ZERO,ZERO,W(1,17))
