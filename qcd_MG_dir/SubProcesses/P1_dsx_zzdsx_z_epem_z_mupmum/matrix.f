...
C     
C     Process: d s~ > z z d s~ QED=2 QCD=2 @1
C     *   Decay: z > e+ e- WEIGHTED=2
C     *   Decay: z > mu+ mu- WEIGHTED=2
C     Process: s d~ > z z s d~ QED=2 QCD=2 @1
C     *   Decay: z > e+ e- WEIGHTED=2
C     *   Decay: z > mu+ mu- WEIGHTED=2
C     
      IMPLICIT NONE
...
C     Amplitude(s) for diagram number 1
      ...
      CALL FFV2_3_2(W(1,7),W(1,6),GC_50,GC_58,ZERO,ZERO,W(1,11))
...
C     Amplitude(s) for diagram number 5
      ...
      CALL FFV2_3_2(W(1,9),W(1,5),GC_50,GC_58,ZERO,ZERO,W(1,14))
