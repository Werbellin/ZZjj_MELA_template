...
C     
C     Process: d u~ > z z d u~ QED=2 QCD=2 @1
C     *   Decay: z > e+ e- WEIGHTED=2
C     *   Decay: z > mu+ mu- WEIGHTED=2
C     Process: d c~ > z z d c~ QED=2 QCD=2 @1
C     *   Decay: z > e+ e- WEIGHTED=2
C     *   Decay: z > mu+ mu- WEIGHTED=2
C     Process: s u~ > z z s u~ QED=2 QCD=2 @1
C     *   Decay: z > e+ e- WEIGHTED=2
C     *   Decay: z > mu+ mu- WEIGHTED=2
C     Process: s c~ > z z s c~ QED=2 QCD=2 @1
C     *   Decay: z > e+ e- WEIGHTED=2
C     *   Decay: z > mu+ mu- WEIGHTED=2
C     
      IMPLICIT NONE
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV2_5_1(W(1,2),W(1,6),GC_51,GC_58,ZERO,ZERO,W(1,11))
...
C     Amplitude(s) for diagram number 4
      ...
      CALL FFV1P0_3(W(1,9),W(1,2),GC_11,ZERO,ZERO,W(1,13))
...
C     Amplitude(s) for diagram number 6
      ...
      CALL FFV2_5_1(W(1,2),W(1,5),GC_51,GC_58,ZERO,ZERO,W(1,14))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,9),W(1,14),W(1,10),GC_11,AMP(7))
      CALL FFV2_3_1(W(1,3),W(1,5),GC_50,GC_58,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,1),W(1,9),W(1,13),GC_11,AMP(8))
      CALL FFV1P0_3(W(1,4),W(1,2),GC_11,ZERO,ZERO,W(1,13))
      CALL FFV1_1(W(1,3),W(1,13),GC_11,ZERO,ZERO,W(1,2))
