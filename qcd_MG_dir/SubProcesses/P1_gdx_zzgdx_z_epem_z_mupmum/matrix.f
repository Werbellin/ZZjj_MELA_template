...
C     
C     Process: g d~ > z z g d~ QED=2 QCD=2 @1
C     *   Decay: z > e+ e- WEIGHTED=2
C     *   Decay: z > mu+ mu- WEIGHTED=2
C     Process: g s~ > z z g s~ QED=2 QCD=2 @1
C     *   Decay: z > e+ e- WEIGHTED=2
C     *   Decay: z > mu+ mu- WEIGHTED=2
C     
      IMPLICIT NONE
...
C     ----------
      ...
      CALL FFV2_3_1(W(1,2),W(1,5),GC_50,GC_58,ZERO,ZERO,W(1,8))
      CALL FFV1_2(W(1,4),W(1,7),GC_11,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL FFV2_3_0(W(1,9),W(1,8),W(1,6),GC_50,GC_58,AMP(1))
      CALL FFV2_3_2(W(1,4),W(1,6),GC_50,GC_58,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,10),W(1,8),W(1,7),GC_11,AMP(2))
      CALL FFV2_3_2(W(1,4),W(1,5),GC_50,GC_58,ZERO,ZERO,W(1,11))
...
C     Amplitude(s) for diagram number 6
      ...
      CALL FFV2_3_1(W(1,12),W(1,5),GC_50,GC_58,ZERO,ZERO,W(1,7))
C     Amplitude(s) for diagram number 7
      CALL FFV2_3_0(W(1,9),W(1,7),W(1,6),GC_50,GC_58,AMP(7))
      CALL FFV2_3_1(W(1,12),W(1,6),GC_50,GC_58,ZERO,ZERO,W(1,14))
...
C     Amplitude(s) for diagram number 12
      ...
      CALL FFV2_3_2(W(1,7),W(1,5),GC_50,GC_58,ZERO,ZERO,W(1,2))
C     Amplitude(s) for diagram number 13
      CALL FFV2_3_0(W(1,2),W(1,4),W(1,6),GC_50,GC_58,AMP(13))
      CALL FFV2_3_2(W(1,7),W(1,6),GC_50,GC_58,ZERO,ZERO,W(1,15))
