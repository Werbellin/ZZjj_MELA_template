...
C     
C     Process: u u~ > z z g g QED=2 QCD=2 @1
C     *   Decay: z > e+ e- WEIGHTED=2
C     *   Decay: z > mu+ mu- WEIGHTED=2
C     Process: c c~ > z z g g QED=2 QCD=2 @1
C     *   Decay: z > e+ e- WEIGHTED=2
C     *   Decay: z > mu+ mu- WEIGHTED=2
C     
      IMPLICIT NONE
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV2_5_2(W(1,1),W(1,5),GC_51,GC_58,ZERO,ZERO,W(1,11))
...
C     Amplitude(s) for diagram number 8
      ...
      CALL FFV1_1(W(1,12),W(1,4),GC_11,ZERO,ZERO,W(1,15))
...
C     Amplitude(s) for diagram number 12
      ...
      CALL FFV1_1(W(1,2),W(1,4),GC_11,ZERO,ZERO,W(1,1))
      CALL FFV2_5_2(W(1,7),W(1,5),GC_51,GC_58,ZERO,ZERO,W(1,2))
C     Amplitude(s) for diagram number 13
      CALL FFV2_5_0(W(1,2),W(1,1),W(1,6),GC_51,GC_58,AMP(13))
      CALL FFV2_5_2(W(1,7),W(1,6),GC_51,GC_58,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 14
      CALL FFV2_5_0(W(1,15),W(1,1),W(1,5),GC_51,GC_58,AMP(14))
      CALL FFV1_2(W(1,7),W(1,4),GC_11,ZERO,ZERO,W(1,14))
...
C     Amplitude(s) for diagram number 18
      ...
      CALL FFV1_1(W(1,1),W(1,3),GC_11,ZERO,ZERO,W(1,2))
C     Amplitude(s) for diagram number 19
      CALL FFV2_5_0(W(1,11),W(1,2),W(1,6),GC_51,GC_58,AMP(19))
      CALL FFV1_2(W(1,11),W(1,3),GC_11,ZERO,ZERO,W(1,14))
C     Amplitude(s) for diagram number 20
      CALL FFV2_5_0(W(1,14),W(1,1),W(1,6),GC_51,GC_58,AMP(20))
C     Amplitude(s) for diagram number 21
      CALL FFV2_5_0(W(1,10),W(1,2),W(1,5),GC_51,GC_58,AMP(21))
      CALL FFV1_2(W(1,10),W(1,3),GC_11,ZERO,ZERO,W(1,2))
C     Amplitude(s) for diagram number 22
      CALL FFV2_5_0(W(1,2),W(1,1),W(1,5),GC_51,GC_58,AMP(22))
      CALL FFV1_2(W(1,9),W(1,3),GC_11,ZERO,ZERO,W(1,1))
C     Amplitude(s) for diagram number 23
      CALL FFV2_5_0(W(1,1),W(1,8),W(1,6),GC_51,GC_58,AMP(23))
      CALL FFV1_1(W(1,8),W(1,3),GC_11,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 24
      CALL FFV2_5_0(W(1,9),W(1,15),W(1,6),GC_51,GC_58,AMP(24))
C     Amplitude(s) for diagram number 25
      CALL FFV2_5_0(W(1,1),W(1,13),W(1,5),GC_51,GC_58,AMP(25))
      CALL FFV1_1(W(1,13),W(1,3),GC_11,ZERO,ZERO,W(1,1))
C     Amplitude(s) for diagram number 26
      CALL FFV2_5_0(W(1,9),W(1,1),W(1,5),GC_51,GC_58,AMP(26))
